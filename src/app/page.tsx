            ...
            <div className="space-y-9">
              ...
              <div className="space-y-6">
                ...
                <h1 className="font-display max-w-5xl text-5xl leading-[0.9] tracking-[-0.065em] text-[color:var(--foreground)] md:text-7xl xl:text-[6.2rem]">
                  A modular platform for intelligence, innovation, and
                  execution.
                </h1>
                <p className="max-w-2xl text-lg leading-8 text-[color:var(--muted-foreground)] md:text-xl">
                  VitaLumen Nexus is an advanced intelligence platform designed
                  to orchestrate innovation, accelerate technology creation, and
                  connect complex systems through a unified architecture.
                </p>
                <p className="max-w-2xl text-base leading-8 text-[color:var(--muted-foreground)]">
                  Built around specialized modules, it gives organizations a
                  structured environment to explore opportunities, generate
                  solutions, validate ideas, and transform knowledge into
              ...
              <Card className="story-card glass-orb relative z-10 w-full max-w-[42rem] rounded-[34px]">
                <CardHeader className="space-y-5 p-7 md:p-9">
                  ...
                  <CardDescription className="text-base leading-8 md:text-lg">
                    A single framework for strategic thinking, technology
                    generation, orchestration, and real-world validation.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-5 p-7 pt-0 md:p-9 md:pt-0">
                  ...
                  <p className="font-display text-2xl tracking-[-0.05em] text-[color:var(--foreground)] md:text-4xl md:leading-[1.08]">
                    Applied deep-tech intelligence for engineering-focused
                    exploration.
                  </p>
                  <p className="text-base leading-8 text-[color:var(--muted-foreground)]">
                    Conceptual analysis, propulsion modeling, and advanced
                    system evaluation inside structured intelligence workflows.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="story-card rounded-[34px]">
              <CardContent className="space-y-6 p-8 md:p-10">
                ...
                <p className="font-display text-3xl leading-tight tracking-[-0.045em] text-[color:var(--foreground)] md:text-4xl">
                  To provide a structured environment where intelligence,
                  innovation, and execution work together.
                </p>
                <p className="text-base leading-8 text-[color:var(--muted-foreground)]">
                  Rather than focusing on one industry, the platform is designed
                  to support multiple domains, including advanced technology,
                  aerospace, intelligent systems, healthcare innovation, and
              ...
              <CardContent className="grid gap-8 p-8 md:grid-cols-[1.1fr_0.9fr] md:p-12">
                <div className="space-y-5">
                  ...
                  <h2 className="font-display text-4xl leading-tight tracking-[-0.05em] md:text-5xl">
                    Applied deep-tech intelligence with an engineering-focused
                    research layer.
                  </h2>
                  <p className="max-w-2xl text-base leading-8 text-white/78">
                    Designed to support conceptual analysis, propulsion
                    modeling, system evaluation, and advanced aerospace
                    exploration through structured intelligence workflows.
                  </p>
                </div>
            ...
            <Card className="story-card rounded-[34px]">
              <CardContent className="space-y-6 p-8 md:p-10">
                ...
                <div className="space-y-5 text-base leading-8 text-[color:var(--muted-foreground)]">
                  <p>
                    Pullumb Vathi është themeluesi i VitaLumen Nexus, një
                    iniciative e fokusuar në eksplorimin e sistemeve
                    inteligjente, inovacionit teknologjik dhe arkitekturave të
                    avancuara për të ardhmen.
                  </p>
                  <p>
                    Vizioni i tij është ndërtimi i një platforme që bashkon
                    inteligjencën, krijimin e teknologjisë dhe mendimin
                    strategjik në një ekosistem të vetëm, të aftë për të
                    mbështetur zhvillimin e ideve dhe zgjidhjeve me ndikim
                    afatgjatë.
                  </p>
                  <p>
                    Puna e tij është përqendruar në konceptimin e modeleve
                    multidisiplinare që lidhin fusha të ndryshme si inteligjenca
                    artificiale, sistemet komplekse, teknologjitë e avancuara
                    dhe inovacioni i vazhdueshëm.
                  </p>
                  <p>
                    Përmes VitaLumen Nexus, ai synon të krijojë një mjedis ku
                    idetë transformohen në struktura të organizuara,
                    teknologjitë zhvillohen në mënyrë sistematike dhe inovacioni
                    trajtohet si një proces i vazhdueshëm.
                  </p>
                </div>
                ...
                <div className="rounded-[30px] border border-[color:var(--border)] bg-[color:var(--secondary)] p-6 md:p-7">
                  ...
                  <p className="mt-4 font-display text-2xl leading-10 tracking-[-0.04em] text-[color:var(--foreground)] md:text-3xl">
                    “Teknologjia nuk duhet të kufizohet vetëm në zgjidhjen e
                    problemeve të sotme. Ajo duhet të krijojë mundësitë e së
                    nesërmes.”
                  </p>
                </div>
              </CardContent>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 rounded-[40px] border border-[color:var(--border-strong)] bg-[color:var(--foreground)] px-7 py-10 text-white md:grid-cols-[1.1fr_0.9fr] md:px-12 md:py-14">
            ...
            <div className="flex flex-col justify-between gap-8 rounded-[30px] border border-white/12 bg-white/6 p-7">
              <p className="text-base leading-8 text-white/76">
                For partnership opportunities, research collaborations, and
                platform inquiries, contact the VitaLumen Nexus team.
              </p>
              <button
                type="button"
                onClick={openContactDialog}
